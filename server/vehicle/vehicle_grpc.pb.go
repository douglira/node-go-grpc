...
type VehicleServiceClient interface {
	StoreVehicle(ctx context.Context, in *VehicleRegistration, opts ...grpc.CallOption) (*Vehicle, error)
	...
	ListVehicles(ctx context.Context, in *Void, opts ...grpc.CallOption) (*VehiclesList, error)
	DeleteVehicle(ctx context.Context, in *VehicleId, opts ...grpc.CallOption) (*Void, error)
}
...
func (c *vehicleServiceClient) StoreVehicle(ctx context.Context, in *VehicleRegistration, opts ...grpc.CallOption) (*Vehicle, error) {
	out := new(Vehicle)
	err := c.cc.Invoke(ctx, "/vehicle.VehicleService/StoreVehicle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vehicleServiceClient) UpdateVehicle(ctx context.Context, in *Vehicle, opts ...grpc.CallOption) (*Vehicle, error) {
	out := new(Vehicle)
	err := c.cc.Invoke(ctx, "/vehicle.VehicleService/UpdateVehicle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vehicleServiceClient) ListVehicles(ctx context.Context, in *Void, opts ...grpc.CallOption) (*VehiclesList, error) {
	out := new(VehiclesList)
	err := c.cc.Invoke(ctx, "/vehicle.VehicleService/ListVehicles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vehicleServiceClient) DeleteVehicle(ctx context.Context, in *VehicleId, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/vehicle.VehicleService/DeleteVehicle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VehicleServiceServer interface {
	StoreVehicle(context.Context, *VehicleRegistration) (*Vehicle, error)
	UpdateVehicle(context.Context, *Vehicle) (*Vehicle, error)
	GetVehicle(context.Context, *VehicleId) (*Vehicle, error)
	ListVehicles(context.Context, *Void) (*VehiclesList, error)
	DeleteVehicle(context.Context, *VehicleId) (*Void, error)
...
func (UnimplementedVehicleServiceServer) StoreVehicle(context.Context, *VehicleRegistration) (*Vehicle, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StoreVehicle not implemented")
}
func (UnimplementedVehicleServiceServer) UpdateVehicle(context.Context, *Vehicle) (*Vehicle, error) {
...
func (UnimplementedVehicleServiceServer) ListVehicles(context.Context, *Void) (*VehiclesList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListVehicles not implemented")
}
func (UnimplementedVehicleServiceServer) DeleteVehicle(context.Context, *VehicleId) (*Void, error) {
...
func _VehicleService_StoreVehicle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VehicleRegistration)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VehicleServiceServer).StoreVehicle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vehicle.VehicleService/StoreVehicle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VehicleServiceServer).StoreVehicle(ctx, req.(*VehicleRegistration))
	}
...
func _VehicleService_UpdateVehicle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vehicle.VehicleService/UpdateVehicle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VehicleService_ListVehicles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vehicle.VehicleService/ListVehicles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VehicleServiceServer).ListVehicles(ctx, req.(*Void))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VehicleService_DeleteVehicle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vehicle.VehicleService/DeleteVehicle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var VehicleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "StoreVehicle",
			Handler:    _VehicleService_StoreVehicle_Handler,
		},
		{
